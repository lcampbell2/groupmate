...
import { k as t, _ as o, s as u, C as c, m as s, a as p, b as l, c as d, d as v, e as y, g as k, f as g } from "./18ee0d5c.mjs";

export { C as CombinedError, f as createRequest, j as getOperationName, a as makeErrorResult, m as makeResult, i as mergeResultPatch, h as stringifyVariables } from "./18ee0d5c.mjs";
...
var W = function Client(e) {
  ...
  var v = composeExchanges(void 0 !== e.exchanges ? e.exchanges : L);
  var y = b(v({
    client: f,
    dispatchDebug: p,
...
export { W as Client, cacheExchange, composeExchanges, z as createClient, debugExchange, dedupExchange, L as defaultExchanges, errorExchange, G as fallbackExchangeIO, fetchExchange, formatDocument, gql, makeOperation, maskTypename, ssrExchange, subscriptionExchange };
