...
function mergeResultPatch(e, r, n) {
  ...
  var i = o.data = _extends({}, o.data);
  var a = 0;
  var s;
  while (a < r.path.length) {
    i = i[s = r.path[a++]] = Array.isArray(i[s]) ? [].concat(i[s]) : _extends({}, i[s]);
  }
  _extends(i, r.data);
  return o;
}
...
var a = "undefined" != typeof Symbol ? Symbol.asyncIterator : null;
...
function executeIncrementalFetch(e, r, t) {
  ...
  return c().then((function next(n) {
    if (!n.done) {
      var i = function toString(e) {
        return "undefined" != typeof Buffer && Buffer.isBuffer(e) ? e.toString() : s.decode(e);
      }(n.value);
      var a = i.indexOf(o);
      if (a > -1) {
        a += h.length;
...
exports.makeFetchSource = function makeFetchSource(e, t, n) {
  ...
  return r.make((function(r) {
    ...
    Promise.resolve().then((function() {
      ...
      return executeIncrementalFetch(a, e, l);
...
//# sourceMappingURL=8a6d4d1f.js.map
